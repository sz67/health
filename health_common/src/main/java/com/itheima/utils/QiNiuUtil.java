...
public class QiNiuUtil {
    ...
    private static final String ACCESSKEY = "lQXBZmo7j9M_nVrYtaDV1Rn8Ezpg1ErSYLsYXpvw";
    private static final String SECRETKEY = "8qtEYwdKTILNaopiYXbg0QIhcoJr8gg1i5W3qPKz";
    private static final String BUCKET = "java_health";
    public static final String DOMAIN= "http://pv4fxi099.bkt.clouddn.com";

    public static void main(String[] args) {
        uploadFile("F:\\java_health_picture\\1.jpg","1.jpg");
